...
%     8.	Remaining: the rest
    ...
    methods
        ...
        %   4) Merging/minimum duration
            ...
            obj.ReplotArms = false; % Set to true to replot the vertices and closed arms for EPM / middle walls for LDB even if it was already done for the file
...
%                         return
                    ...
                    if isfield(Tracking.(Key),'MovieTimes')
                        MovieTimes = Tracking.(Key).MovieTimes;
                        if isempty(Times)
...
%                         end
        ...
        function PlayMovies(obj,Param)
            ...
            if ~isempty(obj.Reader)
                ...
                if ~isempty(DLCIndex) && obj.MovieTimes(DLCIndex)-1/1000<=obj.Reader.Duration
                    if SliderUpdate
                    ...
                    obj.Reader.CurrentTime = obj.MovieTimes(DLCIndex)-1/1000;
